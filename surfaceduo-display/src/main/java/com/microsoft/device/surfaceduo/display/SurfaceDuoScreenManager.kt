...
class SurfaceDuoScreenManager private constructor() {
    ...
    companion object {
        ...
        private val SURFACE_DUO_LIFECYCLE_REGISTER = SurfaceDuoScreenManager()
        private var screenMode = -1

        @JvmStatic fun init(app: Application): SurfaceDuoScreenManager {
            app.registerActivityLifecycleCallbacks(SURFACE_DUO_LIFECYCLE_REGISTER.lifecycleListener)
            return SURFACE_DUO_LIFECYCLE_REGISTER
        }
