...
import androidx.navigation.foldableNavGraphViewModels
...
class NavGraphViewModelLazyTest {
    ...
    fun vmInitialization() {
        ...
        scenario.onFragment { fragment ->
            FoldableNavigation.setViewNavController(fragment.requireView(), navController)
        }
    ...
    fun sameViewModelAcrossFragments() {
        with(ActivityScenario.launch(NavGraphActivity::class.java)) {
            val navController = withActivity { findFoldableNavController(R.id.nav_host_fragment) }
...
class TestVMFragment : Fragment() {
    ...
    val savedStateViewModel: TestSavedStateViewModel by foldableNavGraphViewModels(R.id.vm_graph)
