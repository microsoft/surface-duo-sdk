...
class ActivityTest {
    ...
    fun findNavController() {
        val navHostFragment = FoldableNavHostFragment.create(R.navigation.test_graph)
        fragmentManager.beginTransaction()
            .add(android.R.id.content, navHostFragment)
            .commitNow()

        val foundNavController = contentFragment.findFoldableNavController()
        assertTrue(
    ...
    fun findNavControllerNull() {
        fragmentManager.beginTransaction()
            ...
            .commitNow()
        try {
            contentFragment.findFoldableNavController()
            fail(
