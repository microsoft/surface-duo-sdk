...
class FoldableNavGraphTest {
    private val navGraphNavigator =
        FoldableNavGraphNavigator(mock(FoldableNavigatorProvider::class.java))
    private val navigator = FoldableNoOpNavigator()
    @Test
    fun plusAssign() {
        val graph = FoldableNavGraph(navGraphNavigator)
    ...
    fun plusAssignGraph() {
        val graph = FoldableNavGraph(navGraphNavigator)
        val other = FoldableNavGraph(navGraphNavigator)
