 ...
 * isolation.
 */
fun FoldableNavigatorProvider.navDestination(
    @IdRes id: Int,
    builder: FoldableNavDestinationBuilder<FoldableNavDestination>.() -> Unit
): FoldableNavDestination = FoldableNavDestinationBuilder(this[FoldableNoOpNavigator::class], id).apply(builder).build()
