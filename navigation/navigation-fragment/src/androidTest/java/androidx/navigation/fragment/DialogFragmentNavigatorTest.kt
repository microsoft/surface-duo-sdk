...
class DialogFragmentNavigatorTest {
    ...
    fun testNavigate() {
        ...
        val dialogNavigator =
            FoldableDialogFragmentNavigator(emptyActivity, fragmentManager)
    ...
    fun testFindNavController() {
        ...
        val navController = FoldableNavController(emptyActivity)
        FoldableNavigation.setViewNavController(
            dialogFragment.requireDialog().window!!.decorView,
            navController
        )

        val returnedNavController = FoldableNavHostFragment.findNavController(dialogFragment)
    ...
    fun testPop() {
        ...
        assertWithMessage("DialogNavigator should pop dialog off the back stack")
            .that(dialogNavigator.popBackStack(true))
            .isTrue()
