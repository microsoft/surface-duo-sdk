...
/**
 * Representation of an entry in the back stack of a {@link FoldableNavController}. The
 ...
 */
public final class FoldableNavBackStackEntry implements
        LifecycleOwner,
    ...
    FoldableNavBackStackEntry(@NonNull Context context,
                              @NonNull FoldableNavDestination destination, @Nullable Bundle args,
     ...
     */
    @NonNull
    public FoldableNavDestination getDestination() {
        return mDestination;
    }
    ...
    public ViewModelStore getViewModelStore() {
        if (mNavControllerViewModel == null) {
            throw new IllegalStateException("You must call setViewModelStore() on your "
                    + "FoldableNavHostController before accessing "
