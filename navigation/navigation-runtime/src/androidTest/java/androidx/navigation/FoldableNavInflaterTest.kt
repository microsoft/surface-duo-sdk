...
import androidx.navigation.testutils.TestNavigatorProvider
...
class FoldableNavInflaterTest {
    ...
    fun testInflateSimple() {
        ...
        val navInflater = FoldableNavInflater(context, TestNavigatorProvider())
    ...
    fun testInflateDeepLinkWithApplicationId() {
        ...
        val expectedDeepLinkRequest = FoldableNavDeepLinkRequest.Builder.fromUri(expectedUri).build()
    ...
    fun testInflateDeepLinkWithApplicationIdAction() {
        ...
        assertThat(graph).isNotNull()
        val expectedDeepLinkRequest = FoldableNavDeepLinkRequest.Builder.fromAction("test.action").build()
        val result = graph.matchDeepLink(expectedDeepLinkRequest)
        assertThat(result)
            .isNotNull()
        assertThat(result?.destination)
    ...
    fun testInflateDeepLinkWithApplicationIdEmptyAction() {
        ...
        assertThat(graph).isNotNull()
        val expectedDeepLinkRequest = FoldableNavDeepLinkRequest.Builder
            .fromUri(
                Uri.parse(
                    "android-app://" +
    ...
    fun testInflateDeepLinkWithApplicationIdMimeType() {
        ...
        assertThat(graph).isNotNull()
        val expectedDeepLinkRequest = FoldableNavDeepLinkRequest.Builder.fromMimeType("type/test").build()
        val result = graph.matchDeepLink(expectedDeepLinkRequest)
        assertThat(result)
            .isNotNull()
        assertThat(result?.destination)
