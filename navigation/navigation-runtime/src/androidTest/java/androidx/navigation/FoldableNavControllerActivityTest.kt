...
class FoldableNavControllerActivityTest {

    @Suppress("DEPRECATION")
    @get:Rule
    val activityRule = androidx.test.rule.ActivityTestRule(NavControllerActivity::class.java)

    private lateinit var navController: FoldableNavController
    private lateinit var navigator: TestNavigator

    @Before
    fun setup() {
        navController = FoldableNavController(activityRule.activity)
