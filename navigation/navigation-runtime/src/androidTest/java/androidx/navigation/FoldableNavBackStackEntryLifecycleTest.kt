...
class FoldableNavBackStackEntryLifecycleTest {
    ...
    private fun createNavController(
        ...
        val navController = FoldableNavHostController(ApplicationProvider.getApplicationContext())
