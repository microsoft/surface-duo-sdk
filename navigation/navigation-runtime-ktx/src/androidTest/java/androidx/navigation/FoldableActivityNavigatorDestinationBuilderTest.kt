...
class FoldableActivityNavigatorDestinationBuilderTest {
    ...
    fun activityPackage() {
        ...
        assertWithMessage("Destination should have package name set")
            .that((graph[DESTINATION_ID] as FoldableActivityNavigator.Destination).targetPackage)
    ...
    fun activityClass() {
        ...
        assertEquals(
            ...
            (graph[DESTINATION_ID] as FoldableActivityNavigator.Destination).component?.className
        )
    }
    ...
    fun action() {
        ...
        assertEquals(
            ...
            ACTION,
            (graph[DESTINATION_ID] as FoldableActivityNavigator.Destination).action
        )
    }
    ...
    fun data() {
        ...
        assertEquals(
            ...
            DATA,
            (graph[DESTINATION_ID] as FoldableActivityNavigator.Destination).data
        )
    }
    ...
    fun dataPattern() {
        ...
        assertEquals(
            ...
            DATA_PATTERN,
            (graph[DESTINATION_ID] as FoldableActivityNavigator.Destination).dataPattern
        )
    }
}
