...
/**
 * Create a new [FoldableActivityNavigator.Extras] instance with a specific [ActivityOptionsCompat]
...
public fun FoldableActivityNavigatorExtras(
    activityOptions: ActivityOptionsCompat? = null,
    flags: Int = 0
): FoldableActivityNavigator.Extras = FoldableActivityNavigator.Extras.Builder().apply {
