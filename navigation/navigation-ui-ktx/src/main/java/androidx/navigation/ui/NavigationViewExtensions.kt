...
/**
 * Sets up a [NavigationView] for use with a [FoldableNavController]. This will call
 ...
 * changes.
 */
public fun NavigationView.setupWithFoldableNavController(navController: FoldableNavController) {
