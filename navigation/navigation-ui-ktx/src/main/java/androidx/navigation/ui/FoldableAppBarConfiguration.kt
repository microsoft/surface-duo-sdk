...
/**
 * Configuration options for [FoldableNavigationUI] methods that interact with implementations of the
 ...
 * [androidx.navigation.FoldableNavController.navigateUp] returns `false`
 */
@Suppress("FunctionName") /* Acts like a constructor */
public inline fun FoldableAppBarConfiguration(
    navGraph: FoldableNavGraph,
    drawerLayout: Openable? = null,
    noinline fallbackOnNavigateUpListener: () -> Boolean = { false }
): FoldableAppBarConfiguration = FoldableAppBarConfiguration.Builder(navGraph)
...
public inline fun FoldableAppBarConfiguration(
    ...
    drawerLayout: Openable? = null,
    noinline fallbackOnNavigateUpListener: () -> Boolean = { false }
): FoldableAppBarConfiguration = FoldableAppBarConfiguration.Builder(topLevelMenu)
    .setOpenableLayout(drawerLayout)
    .setFallbackOnNavigateUpListener(fallbackOnNavigateUpListener)
    .build()
...
public inline fun FoldableAppBarConfiguration(
    ...
    drawerLayout: Openable? = null,
    noinline fallbackOnNavigateUpListener: () -> Boolean = { false }
): FoldableAppBarConfiguration = FoldableAppBarConfiguration.Builder(topLevelDestinationIds)
    .setOpenableLayout(drawerLayout)
    .setFallbackOnNavigateUpListener(fallbackOnNavigateUpListener)
    .build()
