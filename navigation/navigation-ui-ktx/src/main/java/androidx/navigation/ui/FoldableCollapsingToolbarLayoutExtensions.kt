...
/**
 * Sets up a [CollapsingToolbarLayout] and [Toolbar] for use with a [FoldableNavController].
 *
 ...
 *
 * This method will call [FoldableNavController.navigateUp] when the Navigation button is clicked.
 *
 ...
 */
public fun CollapsingToolbarLayout.setupWithFoldableNavController(
    toolbar: Toolbar,
...
public fun CollapsingToolbarLayout.setupWithFoldableNavController(
    ...
    FoldableNavigationUI.setupWithFoldableNavController(this, toolbar, navController, configuration)
}
