...
class FoldableNavGraphTest {
    ...
    private fun createGraphWithDestination(destination: FoldableNavDestination) =
        navGraphNavigator.createDestination().apply {
            addDestination(destination)
        }
    private fun createGraphWithDestinations(vararg destinations: FoldableNavDestination) =
        navGraphNavigator.createDestination().apply {
