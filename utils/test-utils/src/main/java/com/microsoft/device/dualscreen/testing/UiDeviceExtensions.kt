...
/**
 * Most of these functions can be used in dualscreen UI tests to simulate swipe gestures that affect
 ...
 *
 * We have also added an utility function to reset the orientation of a device.
 */
