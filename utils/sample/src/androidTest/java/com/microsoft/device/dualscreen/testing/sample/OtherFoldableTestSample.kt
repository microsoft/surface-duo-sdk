...
class OtherFoldableTestSample {
    ...
    fun testLayoutDualScreenPortrait() {
        onView(withId(R.id.text_view_start)).check(matches(isDisplayed()))
        onView(withId(R.id.text_view_start)).check(matches(withText(R.string.dual_portrait_start)))

        onView(withId(R.id.text_view_end)).check(matches(isDisplayed()))
        onView(withId(R.id.text_view_end)).check(matches(withText(R.string.dual_portrait_end)))
    }
}